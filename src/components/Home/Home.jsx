    ...
    return (
        <div className="flex justify-center items-center h-screen">
            <div className='text-center'>
                ...
                >
                    <FiFacebook className=' cursor-pointer border-teal-500 border rounded-full border-double p-2' />
                    <IoLogoTwitter className=' cursor-pointer border-teal-500 border rounded-full border-double p-2' />
                    <FiGithub className='  cursor-pointer border-teal-500 border rounded-full border-double p-2' />
                </div>
            </div>
        </div>
    );
